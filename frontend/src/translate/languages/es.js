...
whatsappModal: {
  ...
  form: {
    ...
    sendIdQueue: "Fila",
        importAlert:
            "ATENCIÓN: Al guardar, su conexión finalizará, deberá escanear el código QR nuevamente para importar los mensajes",
          importOldMessagesEnable: "Importar mensajes desde tu dispositivo",
